 ...
 * const authority2 = getAuthority( 'https://mehdismi.github.io/ictlive/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://mehdismi.github.io/ictlive/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'http://mehdismi.github.io/ictlive/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'http://mehdismi.github.io/ictlive/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://mehdismi.github.io/ictlive/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'http://mehdismi.github.io/ictlive/this/is/a/test.jpg' ); // 'test.jpg'
