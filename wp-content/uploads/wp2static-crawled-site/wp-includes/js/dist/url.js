 ...
 * const authority2 = getAuthority( 'https://OFFLINEZIP.wpshotest/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://OFFLINEZIP.wpshothis/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'http://OFFLINEZIP.wpshothis/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'http://OFFLINEZIP.wpshothis/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://OFFLINEZIP.wpshothis/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'http://OFFLINEZIP.wpshothis/is/a/test.jpg' ); // 'test.jpg'
